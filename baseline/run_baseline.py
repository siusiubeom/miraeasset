...
QUESTIONS = [
    ...
    # 주석 의존 문항 — 답이 요약재무정보가 아니라 자본금 주석에만 있다.
    # tier 3(주석) 가중치가 tier 4(정기보고서 표)보다 낮으면 밀려난다.
    dict(qid="Q13", type="추출/Closed",
         q="삼성전자 2025년 사업보고서의 자본금 주석에서 발행주식 액면총액과 "
           "납입자본금이 다른 이유는?",
         companies=["삼성전자"], gold_docs=docs("삼성전자", "periodic", "annual", 2025),
         # '이익소각'은 자본금 변동사항·주식의 총수 절에도 있어 변별이 안 된다.
         # 18. 자본금 주석에만 있는 문구로 잡는다.
         evidence=r"자본금에 대한 기술"),
]
